<li>
  ...
  <a class="<?= do_shortcode('[ct id="ct_Classifica_radio_a43a"]') ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?><span></span><span class="pull-right glyphicon glyphicon-chevron-right"></span></i></a>
